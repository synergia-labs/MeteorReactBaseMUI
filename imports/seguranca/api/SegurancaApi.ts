...
class SegurancaApi {
	 ...
	 * @param msgErro
	 */
	validarAcessoRecursos(user: IUserProfile,recursos: string [], msgErro: string = 'Você não tem permissao para realizar essa operação'): void {
