...
import { SysTextField } from '/imports/ui/components/SimpleFormFields/sysTextField/sysTextField';
...
const ExampleDetailView = () => {
	...
	const handleTelefone = (e) => {
		e.target.value === '' ? setTelefone(true) : setTelefone(false);
	};
			...
			<SimpleForm
				...
				<ExampleDetailStyledContainer sx={{ padding: 0 }}>
					<ExampleDetailStyledBody>
						<ExampleDetailStyledFormContainer>
							...
							<SysTextField
								...
								name="description"
								maxCaracteres={30}
								showNumberCharactersTyped={true}
							/>
							...
							<FormGroup key={'fieldsThree'} {...{ formType: 'subform', name: 'contacts' }}>
								<SysTextField key={'f3-TelefoneKEY'} placeholder="Telefone" name="phone" onChange={handleTelefone} />
								<SysTextField key={'f3-CPFKEY'} placeholder="CPF" name="cpf" disabled={telefone} />
								<SysTextField key={'f3-CodeIDY'} placeholder="Código" name="codeID" disabled={telefone} />
							</FormGroup>
					...
					<ExampleDetailStyledFooter>
						...
						<SysButton key={'btnSave'} id="submit" startIcon={<CheckIcon />}>
							{'Salvar'}
						</SysButton>
					</ExampleDetailStyledFooter>
				</ExampleDetailStyledContainer>
