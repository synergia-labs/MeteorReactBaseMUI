...
abstract class ActionsBase< Server extends ServerBase, Param = unknown, Return = unknown> {
    ...
    public getParamSch(): ZodTypeAny | undefined { return this.paramSch; };
    public getReturnSch(): ZodTypeAny | undefined { return this.returnSch; };
	public getEndpointType(): EndpointType | undefined { return this.endpointType; };
    //endregion
