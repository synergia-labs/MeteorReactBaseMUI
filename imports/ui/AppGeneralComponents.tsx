...
const DialogContainer = (options: IDialogContainerOptions = {...commonOptions, customPaperProps:{}, customDialogActionsProps: {},  content: () => <></>}) => {
  return (
    ...
    return (
      <React.Fragment>
        ...
        {this.state.modalOptions ?
          <ModalContainer {...this.state.modalOptions}
            theme={this.props.theme} /> : null}
        {RenderAppComponent}
      </React.Fragment>
    );
