...
export default ({
  ...
  const handleChangeCheck = (
    ...
    onChange({name, target: {name, value: itemCheck}},
        {name, value: itemCheck});
  };
        ...
        {!readOnly && list ? (
            ...
            list ? (
                <div style={{
                  ...
                  {list.filter(itemCheck => !!value &&
                      (value === itemCheck || value === itemCheck.value)).
                      map(itemCheck => <div style={{
                        color: (value !== itemCheck && value !==
                            itemCheck.value) ? '#999' : undefined,
                      }}>{((value === itemCheck) || (value === itemCheck.value))
                          ? <Check style={{fontSize: 12, paddingRight: 10}}/>
