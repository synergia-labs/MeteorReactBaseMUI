            ...
            <div>
                ...
                {hasValue(this.props.value) && this.props.value != '' && this.props.value != '-' ?
                    (
                        ...
                        <div style={avatarGeneratorStyle.containerEmptyAvatar}>{'Não há avatar'}</div> : null)
                }
                ...
                {!this.props.readOnly ?
                    <div>
                        ...
                        >
                                    ...
                                    >
                                        {list.filter(item => ['neck', 'nose'].indexOf(item) === -1).map(character => (
                                            ...
                                            >
                                                <div
                                                    onClick={() => this.setState({
                                                        [character]: {
                                                            ...
                                                            color: characteres[character].colors[characteres[character].colors.indexOf(this.state[character] ? this.state[character].color : characteres[character].colors[0]) + 1] || characteres[character].colors[0],
                                                        },
                                                    })}
                                                    style={{
                                                        backgroundColor: 'white',
                                                        ...
                                                        alignItems: 'center',
                                                        color: this.state[character] ? this.state[character].color : characteres[character].colors[0],
                                                        border: '3px solid',
                                                        textAlign: 'center',
                                                        fontSize: '11px',
                                                        fontWeight: '600',
                                                        borderColor: this.state[character] ? this.state[character].color : characteres[character].colors[0],
                                                        paddingTop: '20px',
                                                    }}
                                                >
                                                    {'TROCAR COR'}
                                                ...
                                                >
                                                    <div
                                                        onClick={character === 'body' ? undefined : () => this.setState({
                                                            [character]: {
                                                                format: null,
                                                    ...
                                                    {Object.keys(characteres[character].formats).map(format => (<div
                                                        key={format}
                                                        onClick={() => this.setState({
                                                            [character]: {
                                                                format,
                                                                color: this.state[character] && this.state[character].color ? this.state[character].color : characteres[character].colors[0],
                                                            },
                                                        })}
                                                        style={{
                                                    ...
                                                    >
                                                        <CharView
                                                            key={character + format} name={character + format}
                            ...
                            <DialogActions>
                                <Button
                                    id="Fechar Avatar" autoFocus onClick={this.onClose} variant={'outlined'}
                                    color={'#74B9FF'} style={{borderColor: '#74B9FF', color: '#74B9FF'}}
                                >
                                    {'Fechar'}
                                </Button>
                                <Button
