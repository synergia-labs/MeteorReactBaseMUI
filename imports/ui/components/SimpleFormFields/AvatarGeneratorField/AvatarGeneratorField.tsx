    ...
    characteres[character].formats[charObj.format].forEach((subFormat) => {
      if (typeof subFormat === "string") {
        ...
        var path = new Konva.Line({
          ...
          stroke:
            subFormat.stroke || subFormat.fill || charObj.color || "#000000",
...
class AvatarGeneratorField extends React.Component<IBaseSimpleFormComponent> {
  ...
  onSave = () => {
    ...
    const name = this.props.name;
    this.props.onChange(
      { target: { value: imageData } },
      { name, value: imageData }
    );
  };
                      ...
                      .map((character) => (
                        ...
                        >
                          ...
                          >
                            ...
                            {Object.keys(characteres[character].formats).map(
                              (format) => (
                                <div
                                  key={format}
                                  onClick={() =>
                                  ...
                                  style={{
                                    backgroundColor:
                                      this.state[character] &&
                                      this.state[character].format === format
                                        ? "#ffe691"
                                        : "#FFFFFF",
                                    height: 100,
                                    width: 100,
