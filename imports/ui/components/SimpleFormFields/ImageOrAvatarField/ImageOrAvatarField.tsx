...
import AvatarGeneratorField
  from '/imports/ui/components/SimpleFormFields/AvatarGeneratorField/AvatarGeneratorField';
...
export default ({
  ...
  const handleOnChangeAvatar = (evt) => {
    setImageOrAvatar((evt.target.value === '-' || evt.target.value === null)
        ? null
        : 'avatar');
  ...
  return (
      <div
          key={name}
          style={error
              ? imageOrAvatarStyle.containerImageOrAvatarError
              : imageOrAvatarStyle.containerImageOrAvatar}
      >
            ...
            (<div key={name} id={name}>
              {hasValue(value) && value != '' && value != '-' ?
                  (<div>
                      ...
                      ?
                      <div
                          style={imageOrAvatarStyle.containerEmptyMidia}>{'Não há mídia'}</div>
                      : null)
              }
            </div>) : null}
