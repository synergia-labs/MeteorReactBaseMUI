  ...
  render() {
    return (
        <div style={mapsFieldStyles.container}>
          ...
          >
            {this.props.label ? (
                <SimpleLabelView style={mapsFieldStyles.labelTitle}
            ...
            <div style={mapsFieldStyles.mapContainer}>
              <Map
                  ...
                  initialCenter={this.props.value.position
              ...
              >
                {this.props.value.position && this.props.value.position.lat &&
                this.props.value.position.lng ?
                    <Marker
                        name={'Location'}
