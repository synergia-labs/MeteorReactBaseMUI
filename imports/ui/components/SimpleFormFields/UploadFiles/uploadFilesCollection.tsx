...
class UploadFile extends React.Component<IUploadFileProps & IUploadFilesCollection, IUploadFileState> {
    ...
    getListReadOnly = () => (this.state.links.length > 0
            ...
            return (
                ...
                >
                  ...
                  {item.status && item.status === 'InProgress' ? (
                    ...
                    />
                    <IconButton
                        onClick={() => this.excluirArquivo(item.id)}
                    >
        ...
        >
            ...
            >
                <img
                    ...
                    style={{maxWidth: 40, maxHeight: 40, height: '100%', width: '100%', paddingRight: 10}}
                />
