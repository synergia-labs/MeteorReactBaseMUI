...
export default ({
    ...
    if (image) {
      ...
      img.onload = function() {
        ...
        if (width > height) {
          ...
          const newH = acceptMaxValue ? (maxValue / width) * height : (300 /
              width) * height;
  ...
  return (
      <div key={name} style={{
        ...
        {!!readOnly ? ((hasValue(actualImage) && actualImage != '' &&
                    actualImage != '-') ?
                    (<div key={name}>
                      <div style={{
            ...
            (!actualImage && !!image ?
                (
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <div id={`buttonInsert${name}`} data-cy="dropzone"
                             style={{
                ...
                (hasValue(actualImage) && actualImage != '' && actualImage !=
                    '-' ?
                        (<div key={name}>
                          <div style={{
                            height: (window.innerWidth) < 901
                                ? (window.innerWidth / 3)
                                : 'auto',
                            transform: (window.innerWidth) < 901
                                ? `scale(${((window.innerWidth -
                                    (isMobile ? 44 : 130)) / 900)})`
                                : undefined,
                            transformOrigin: (window.innerWidth) < 901
                                ? '0 0'
                                : undefined,
                          }}>
                            <img
