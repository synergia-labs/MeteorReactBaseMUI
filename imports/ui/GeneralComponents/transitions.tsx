...
export const ShowNotificationTransitions = ({ 
    ...
    function SlideTransition(props: SlideProps) { return <Slide {...props} direction={direction} />;}
    function GrowTransition(props: GrowProps)   { return <Grow {...props} />;}
    function FadeTransition(props: FadeProps)   { return <Fade {...props} />;}
    function ZoomTransition(props: ZoomProps)   { return <Zoom {...props} />;}
